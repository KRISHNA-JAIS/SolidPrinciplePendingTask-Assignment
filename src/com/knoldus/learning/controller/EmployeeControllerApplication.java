...
public class EmployeeControllerApplication {
    ...
    public static void main(String[] a) {
        LetsValidate_EmployeeService validateEmployeeService =
                new LetsValidate_Employee_Service_Implement();
        Save_Employee_Service save_emplservice =
                new Save_Employee_Service_Implement();
...
//        loop has been replaced by csv file
        File newfile =
                new File("src/com/knoldus/learning/controller/emplName.csv");
        String line;
        try {
